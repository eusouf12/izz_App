class ApiUrl {
  ...
  static const String baseUrl ="https://spokesman-christopher-heading-ultimately.trycloudflare.com/api/v1";
  ...
  static String deleteAccount({required String userId}) =>
      "/users/delete-my-account/$userId";
  ...
  static String specificUserBookings({required String id}) =>
      "/venue-bookings/specific-user-bookings/$id";
  ...
  static String vendorBookingsByStatus({required String status}) =>
      "/venue-bookings/specific-vendor-bookings?filter=${status.toLowerCase()}";

  /// ======================== user =======================
  static String initialText({required String id}) => "/messages/my-channel/$id";
  static String initialSendText({required String id}) =>
      "/messages/send-message/$id";
  static String chatList({required String page}) =>
      "/messages/channels?page=$page&limit=10";
  static String getAllChat({
    required String channelName,
    required String page,
  }) => "/messages/get-message/$channelName/?page=$page&limit=10";
  ...
  static String nearByEvent({
    required String page,
    required String lat,
    required String lon,
  }) =>
      "/venues/nearby-me?page=$page&limit=10&userslatitude= $lat&userslongitude= $lon";
  ...
  static String getFilterLocVenueName({
    required String page,
    String? sportsType,
  }) {
    String url = "/venues/group-by-sports-type?page=$page&limit=10";
  ...
  static String bookingsByStatus({required String status}) =>
      "/venue-bookings/specific-user-bookings?filter=${status.toLowerCase()}";
}
