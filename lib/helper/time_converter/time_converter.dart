...
static String formatServerTime(String serverTime) {
 ...
 static String calculateAge(String dateOfBirth) {
  ...
  /// Returns the date 14 days after the given DateTime
  static String estimatedDateAfter14Days(DateTime dateTime) {
    final dateAfter14Days = dateTime.add(const Duration(days: 14));
    return DateFormat('dd MMM yyyy').format(dateAfter14Days);
  }
