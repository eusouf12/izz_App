...
import 'custom_image_add_send_controller.dart';
          ...
          children: [
            Expanded(
              child: TextField(
                ...
                style: TextStyle(color: model.textColor ?? Colors.white),
                decoration: InputDecoration(
                 ...
                 // enabledBorder: InputBorder.none,
                  suffixIcon: GestureDetector(
                    onTap: model.imageOnTapButton,
                    // onTap: customImageAddSendController.pickImage,
                    child: Icon(Icons.image,
                        color: model.imageIconColor ?? Colors.white),
                  ),
                  hintText: 'Type a message',
                  hintStyle:
                      TextStyle(color: model.hintTextColor ?? Colors.white),
                  filled: true,
                  fillColor: model.fillColor ?? Colors.grey,
