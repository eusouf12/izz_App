  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final double progress = data.nextLevelXP == 0 ? 0
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                      ...
                      children: [
                        Obx(() {
                          ...
                          return Stack(
                            ...
                            children: [
                              CustomNetworkImage(
                                imageUrl: user.photo.isNotEmpty  ? user.photo : AppConstants.profileImage,height: 80, width: 80,
                ...
                CustomText(
                  text: "XP: ${data.currentXP} / ${data.nextLevelXP} to Level ${data.currentLevel + 1}",  ),
